...
Demo.data.InfiniteCarouselStore = new Ext.data.Store({
    model: 'Pages',
    data: [
        { cmp: '{ "html" : "Page Index : 1" }' }, //xtype defaults to panel
        {cmp: '{ "html" : "Page Index : 2" }' },
        { cmp: '{ "html" : "Page Index : 3" }' },
        { cmp: '{ "html" : "Page Index : 4" }' },
        { cmp: '{ "html" : "Page Index : 5" }' }
    ]
});
...
Demo.data.TouchGridPanelStore = new Ext.data.Store({
...
Ext.regModel("MultiSelect", {
    fields: [
        { name: "text", type: "string" },
        { name: "value", type: "string" }
    ]
});
Demo.data.MultiSelectStore = new Ext.data.Store({
    model: "MultiSelect",
    data: [
        { text: "One", value: "1" },
        { text: "Two", value: "2" },
...
Demo.data.AccordionStore = new Ext.data.Store({
    model: 'Contact',
    sorters: 'firstName',

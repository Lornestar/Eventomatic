<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Seller_Attendee_List.aspx.cs" Inherits="Eventomatic.Seller_Attendee_List" MasterPageFile="~/Site.Master"%>
...
<asp:Content runat="server" ID="content" ContentPlaceHolderID="body">
    ...
    <td >
            <table width="100%"> 
                ...
                <tr>
                <td>
<igtab:UltraWebTab ID="UltraWebTab1" runat="server" Width=100% ontabclick="UltraWebTab1_TabClick" AutoPostBack=true>
                <Tabs>
...
<igtbl:UltraGridColumn Width="50px" BaseColumnName="TixNum">
            <Header Caption="Num">
...
<igtbl:UltraGridBand>
    <Columns>
        <igtbl:UltraGridColumn BaseColumnName="GuestList_First_Name">
        <CellStyle TextOverflow=Ellipsis>
            </CellStyle>
            <Header Caption="First Name">
            </Header>
        </igtbl:UltraGridColumn>
        <igtbl:UltraGridColumn BaseColumnName="GuestList_Last_Name">

...
function SetupUI()
{
	...
	try
	{
		...
		startTimeDropDown = igedit_getById("UltraWebTab1__ctl0_ctl00_ddStartTime");//oUltraWebTab1__ctl0__ctl0_ddStartTime;
		endTimeDropDown = igedit_getById("UltraWebTab1__ctl0_ctl00_ddEndTime");//oUltraWebTab1__ctl0__ctl0_ddEndTime;
/*		var tim = igedit_getById('UltraWebTab1__ctl0_ctl00_ddStartTime');
	alert(tim);
    tim.setValue(convertDateTimeToString(startDate));*/
	}
	catch(e)
	{
		startTimeDropDown = document.getElementById("igtxtUltraWebTab1__ctl0_ctl00_ddStartTime");//oUltraWebTab1__ctl0_ctl00_ddStartTime;
		endTimeDropDown = document.getElementById("igtxtUltraWebTab1__ctl0_ctl00_ddEndTime");//oUltraWebTab1__ctl0_ctl00_ddEndTime;
	}
	
	//alert(startTimeDropDown);
	...
	*/
	...
	startTimeLabel508.htmlFor = startTimeDropDown.id;
	endDateLabel508.htmlFor = endDateChooser.inputBox.id;
	endTimeLabel508.htmlFor = endTimeDropDown.id;
...
function InitializeValues()
{
	...
	startTimeDropDown.setValue(startDate);
	...
	endTimeDropDown.setValue(endDate);
...
{	
	if(oButton.Key != "High" && oButton.Key != "Low" )
	{
		...
		else if(oButton.Index == 1) // Print
		{
			...
			frameDocument.getElementById("SubjectLabel").innerHTML =  document.getElementById("UltraWebTab1__ctl0__ctl0_SubjectLabel").innerHTML;
			frameDocument.getElementById("tbSubject").innerHTML = document.getElementById("tbSubject").value;
			frameDocument.getElementById("LocationLabel").innerHTML =  document.getElementById("UltraWebTab1__ctl0__ctl0_LocationLabel").innerHTML;
			frameDocument.getElementById("tbLocation").innerHTML = document.getElementById("tbLocation").value;
			frameDocument.getElementById("StartTimeLabel").innerHTML = document.getElementById("UltraWebTab1__ctl0__ctl0_StartTimeLabel").innerHTML;
			frameDocument.getElementById("EndTimeLabel").innerHTML = document.getElementById("UltraWebTab1__ctl0__ctl0_EndTimeLabel").innerHTML;
			...
			frameDocument.getElementById("AllDayEventLabel").innerHTML = document.getElementById("UltraWebTab1__ctl0__ctl0_AllDayEventLabel").innerHTML;
			frameDocument.getElementById("cbReminder").checked = document.getElementById("cbReminder").checked;
			frameDocument.getElementById("cbReminderLabel").innerHTML = document.getElementById("UltraWebTab1__ctl0__ctl0_ReminderLabel").innerHTML;
...
function updateRecurrence(appointment, recurrence)
{
	...
	if(recurrence != null)
	{
		...
		document.getElementById("UltraWebTab1__ctl0__ctl0_recurrenceDescriptionText").innerHTML = AppointmentDialogStrings[6]; 
...
function cbAllDayEvent_Clicked()
{
	...
	{
		startTimeDropDown.elem.style.visibility = ""; 
		startTimeDropDown.elem.style.display = "";
		endTimeDropDown.elem.style.visibility = ""; 
		endTimeDropDown.elem.style.display = "";
		td1.style.display = "";

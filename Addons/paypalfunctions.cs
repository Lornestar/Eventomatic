...
public class NVPAPICaller
{
    ...
    private string APIUser = "Lorne@Lornestar.com";
    //Fill in the APIPassword variable yourself, the wizard will not do this automatically
    private string APIPassword = "";
    private string APIVendor = "Lorne@Lornestar.com";
    private string APIPartner = "Lorne@Lornestar.com";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
		...
		string returnURL = "http://www.sellitallstore.com/returnurl.aspx";
        string cancelURL = "http://www.sellitallstore.com/returnurl.aspx";
...
public sealed class NVPCodec : NameValueCollection
{
    ...
    /// 
    /// </summary>
    public string this[string name, string val, int index]
    {
        get
        {

...
namespace Eventomatic_DB
{
	...
	public partial class AspnetPath : ActiveRecord<AspnetPath>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Paths", TableType.Table, DataService.GetInstance("Eventomatic"));
				...
				DataService.Providers["Eventomatic"].AddSchema("aspnet_Paths",schema);
			}
		}
		#endregion
		...
		public Eventomatic_DB.AspnetPersonalizationAllUserCollection AspnetPersonalizationAllUsers()
		{
			return new Eventomatic_DB.AspnetPersonalizationAllUserCollection().Where(AspnetPersonalizationAllUser.Columns.PathId, PathId).Load();
		}
		public Eventomatic_DB.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			return new Eventomatic_DB.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.PathId, PathId).Load();
		}
		#endregion

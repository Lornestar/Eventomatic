...
namespace Eventomatic_DB
{
	...
	public partial class AspnetRole : ActiveRecord<AspnetRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Roles", TableType.Table, DataService.GetInstance("Eventomatic"));
				...
				DataService.Providers["Eventomatic"].AddSchema("aspnet_Roles",schema);
			}
		}
		#endregion
		...
		{
			return new Eventomatic_DB.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.RoleId, RoleId).Load();
		}
		#endregion
		...
		public Eventomatic_DB.AspnetUserCollection GetAspnetUserCollection() { return AspnetRole.GetAspnetUserCollection(this.RoleId); }
		public static Eventomatic_DB.AspnetUserCollection GetAspnetUserCollection(Guid varRoleId)
		{

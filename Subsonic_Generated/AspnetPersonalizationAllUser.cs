...
namespace Eventomatic_DB
{
	...
	public partial class AspnetPersonalizationAllUser : ActiveRecord<AspnetPersonalizationAllUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationAllUsers", TableType.Table, DataService.GetInstance("Eventomatic"));
				...
				DataService.Providers["Eventomatic"].AddSchema("aspnet_PersonalizationAllUsers",schema);
			}
		}
		#endregion

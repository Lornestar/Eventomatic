...
namespace Eventomatic_DB
{
	...
	public partial class AspnetPersonalizationPerUser : ActiveRecord<AspnetPersonalizationPerUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationPerUser", TableType.Table, DataService.GetInstance("Eventomatic"));
				...
				DataService.Providers["Eventomatic"].AddSchema("aspnet_PersonalizationPerUser",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public Eventomatic_DB.AspnetPath AspnetPath
		{
			get { return Eventomatic_DB.AspnetPath.FetchByID(this.PathId); }
		...
		/// 
		/// </summary>
		public Eventomatic_DB.AspnetUser AspnetUser
		{
			get { return Eventomatic_DB.AspnetUser.FetchByID(this.UserId); }

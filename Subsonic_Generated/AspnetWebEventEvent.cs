...
namespace Eventomatic_DB
{
	...
	public partial class AspnetWebEventEvent : ActiveRecord<AspnetWebEventEvent>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_WebEvent_Events", TableType.Table, DataService.GetInstance("Eventomatic"));
				...
				DataService.Providers["Eventomatic"].AddSchema("aspnet_WebEvent_Events",schema);
			}
		}
		#endregion

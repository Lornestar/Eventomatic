...
namespace Eventomatic_DB
{
	...
	public partial class AspnetUsersInRole : ActiveRecord<AspnetUsersInRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_UsersInRoles", TableType.Table, DataService.GetInstance("Eventomatic"));
				...
				DataService.Providers["Eventomatic"].AddSchema("aspnet_UsersInRoles",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public Eventomatic_DB.AspnetRole AspnetRole
		{
			get { return Eventomatic_DB.AspnetRole.FetchByID(this.RoleId); }

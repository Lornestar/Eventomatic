...
namespace Eventomatic_DB
{
	...
	public partial class AspnetApplication : ActiveRecord<AspnetApplication>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Applications", TableType.Table, DataService.GetInstance("Eventomatic"));
				...
				DataService.Providers["Eventomatic"].AddSchema("aspnet_Applications",schema);
			}
		}
		#endregion
		...
		{
			return new Eventomatic_DB.AspnetMembershipCollection().Where(AspnetMembership.Columns.ApplicationId, ApplicationId).Load();
		}
		public Eventomatic_DB.AspnetPathCollection AspnetPaths()
		{
			return new Eventomatic_DB.AspnetPathCollection().Where(AspnetPath.Columns.ApplicationId, ApplicationId).Load();
		}
		public Eventomatic_DB.AspnetRoleCollection AspnetRoles()
		{
			return new Eventomatic_DB.AspnetRoleCollection().Where(AspnetRole.Columns.ApplicationId, ApplicationId).Load();
		}
		public Eventomatic_DB.AspnetUserCollection AspnetUsers()
		{
			return new Eventomatic_DB.AspnetUserCollection().Where(AspnetUser.Columns.ApplicationId, ApplicationId).Load();
		}
		#endregion

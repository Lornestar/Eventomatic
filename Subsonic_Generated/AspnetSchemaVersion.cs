...
namespace Eventomatic_DB
{
	...
	public partial class AspnetSchemaVersion : ActiveRecord<AspnetSchemaVersion>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_SchemaVersions", TableType.Table, DataService.GetInstance("Eventomatic"));
				...
				DataService.Providers["Eventomatic"].AddSchema("aspnet_SchemaVersions",schema);
			}
		}
		#endregion

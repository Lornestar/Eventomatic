...
namespace Eventomatic_DB
{
	...
	public partial class AspnetMembership : ActiveRecord<AspnetMembership>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Membership", TableType.Table, DataService.GetInstance("Eventomatic"));
				...
				DataService.Providers["Eventomatic"].AddSchema("aspnet_Membership",schema);
			}
		}
		#endregion
